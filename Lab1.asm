...
.data
	...
	pulaLinha: .asciiz "\n"
	tab: .asciiz "	"
	msgErro0: .asciiz "Erro! A matriz possui uma linha cujos coeficientes são nulos. Tente novamente.\n\n"
...
menu:	la $a0, tituloPrograma # imprime na tela o tï¿½tulo do programa
	li $v0, 4
	syscall
...
# $a1 = endereï¿½o de inicio da matriz
# $f8 = 0 em double
...
DecomposicaoLU:
	...
	la $t1,vetor # endereï¿½o do vetor de modificaï¿½oes
	la $t5,const1Double
...
exit9:		
	...
	add $t0,$t0,$a1 # acrescenta no endereï¿½o de comeï¿½o da matriz
